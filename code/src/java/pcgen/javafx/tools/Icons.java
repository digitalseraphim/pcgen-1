...
public enum Icons
{
	...
	/** Image cache */
	private static final EnumMap<Icons, Image> ICON_MAP = new EnumMap<>(Icons.class);
	 ...
	 * on failure
	 */
	private static Image createImageIcon(String fileName)
	{
